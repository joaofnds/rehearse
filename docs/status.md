...
| Session confirmation           | Repeated frozen inputs, retained failures, per-attempt checks, projected budget including model preflight, which a session can overrun by one call                                                                                                                                                                                                                                                   | [Session confirmation](../src/benchmark/session-confirmation.ts)                                                                                                                                                                                                                 |
...
| Session context manifests      | Deduplicated loads the transcript records (successful Reads, instruction files, skill bodies, the output style), corpus/project classification, and declared-input reconciliation; no timeline                                                                                                                                                                                                       | [Manifest construction](../src/benchmark/context-manifest.ts)                                                                                                                                                                                                                    |
