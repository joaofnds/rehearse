...
| Comparison reports             | Baseline/candidate/control arms over at least two cases, or one case in session mode; stage, pipeline, and browser-validated provider-free session evidence                                                 | [Comparison loader](../src/benchmark/comparison-loader.ts)                                                                                                                                                                                                                       |
